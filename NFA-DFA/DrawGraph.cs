...
namespace NFA_DFA
{
    public partial class DrawGraph : Form
    {
        ...
        public int CounterL1 = 0; // for save index of Line Array to continue create vector arrow
        ...
        {
            // Create BeiziLoop
            this.BeiziLoop[numberlop] = new Microsoft.VisualBasic.PowerPacks.OvalShape();
            this.BeiziLoop[numberlop].Location = Q;
            this.BeiziLoop[numberlop].Size = new System.Drawing.Size(17, 29);
            this.BeiziLoop[numberlop].BorderColor = color;
            this.PointShape.Shapes.Add(BeiziLoop[numberlop]);            
            
            // Create Right Arrow of Beizi
            this.Line[CounterL1] = new Microsoft.VisualBasic.PowerPacks.LineShape();
            this.Line[CounterL1].BorderColor = color;
            this.Line[CounterL1].X1 = BeiziLoop[numberlop].Location.X + 8;
            this.Line[CounterL1].X2 = BeiziLoop[numberlop].Location.X + 6;
            this.Line[CounterL1].Y1 = BeiziLoop[numberlop].Location.Y + 20;
            this.Line[CounterL1].Y2 = BeiziLoop[numberlop].Location.Y + 28;
            this.PointShape.Shapes.Add(Line[CounterL1]);
            CounterL1++;
            ...
            this.Line[CounterL1] = new Microsoft.VisualBasic.PowerPacks.LineShape();
            this.Line[CounterL1].BorderColor = color;
            this.Line[CounterL1].X1 = BeiziLoop[numberlop].Location.X - 3;
            this.Line[CounterL1].X2 = BeiziLoop[numberlop].Location.X + 6;
            this.Line[CounterL1].Y1 = BeiziLoop[numberlop].Location.Y + 26;
            this.Line[CounterL1].Y2 = BeiziLoop[numberlop].Location.Y + 29;
            this.PointShape.Shapes.Add(Line[CounterL1]);
            CounterL1++;
